...
class TestAndAssignment extends StatefulWidget {
  ...
  const TestAndAssignment({Key key, @required this.testassignment}) : super(key: key);
  @override
...
class _TestAndAssignmentState extends State<TestAndAssignment> {
 int tabindex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    body: widget.testassignment.length!=0 ? ListView.builder(
    ...
    title: Text('Subject : ${widget.testassignment[index].subjectName}',style: TextStyle(
      color: Colors.white
    ),),
    subtitle: Text('Description : ${widget.testassignment[index].description}',
    style: TextStyle(
      color: Colors.white
    ),
    ),
        ...
        child: Text('No Test& Assignment is Posted',
        style: TextStyle(
            fontSize: 30.0,
